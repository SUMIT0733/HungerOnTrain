...
jQuery(function($){
  ...
  /* ----------------------------------------------------------- */ 
    ...
    $('#blue').click(function (e){
      $('#switcher').attr('href','assets/css/theme-color/blue-theme.css');
      e.preventDefault();
    });
    ...
    $('#violet').click(function (e){
      $('#switcher').attr('href','assets/css/theme-color/violet-theme.css');
      e.preventDefault();
    });
    ...
    $('#tan').click(function (e){
      $('#switcher').attr('href','assets/css/theme-color/tan-theme.css');
      e.preventDefault();
    });
