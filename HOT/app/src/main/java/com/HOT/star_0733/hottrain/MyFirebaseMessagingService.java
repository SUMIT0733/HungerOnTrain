...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
      ...
      private void sendNotification(String notificationTitle, String notificationBody) {
            ...
            Intent ii = new Intent(getApplicationContext(), User_login.class);
            ...
            mBuilder.setSmallIcon(R.drawable.hot);
            mBuilder.setBadgeIconType(R.drawable.hot);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                  NotificationChannel channel = new NotificationChannel("notify_001", "HOT", NotificationManager.IMPORTANCE_DEFAULT);
